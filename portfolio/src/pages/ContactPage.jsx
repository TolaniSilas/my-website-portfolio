        ...
        <div className="grid md:grid-cols-2 gap-16 items-start">
          ...
          <div>
            ...
            <div className="space-y-6 lg:space-y-10">
              {/* Email */}
              <div className="flex items-center p-4 rounded-xl border border-gray-300 dark:border-gray-700 hover:border-purple-500 transition transform hover:-translate-y-2 hover:shadow-lg duration-300 ease-in-out space-x-6">
            ...
            <form ref={formRef} onSubmit={sendEmail} className="space-y-6">
              ...
              <div className="flex justify-start">
                <button
                  type="submit"
                  disabled={loading}
                  className="flex items-center gap-2 bg-purple-600 hover:bg-purple-700 text-white py-2 px-6 rounded-xl font-semibold transition transform hover:-translate-y-1 hover:shadow-lg duration-300 ease-in-out"
                >
                  {loading ? "Sending..." : (
                    <>
